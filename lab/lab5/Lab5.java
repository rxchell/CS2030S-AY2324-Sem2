...
class Lab5 {
  ...
  public static String getGrade(String student, String module, String assessment,
    ...
    Transformer<Map<String, Map<String, String>>, Maybe<Map<String, String>>> getModule = 
        new Transformer<>() {
          public Maybe<Map<String, String>> transform(Map<String, Map<String, String>> moduleMap) {
            return Maybe.of(moduleMap.get(module));
          }
        };

    Transformer<Map<String, String>, Maybe<String>> getAssessment = 
        new Transformer<>() {
          public Maybe<String> transform(Map<String, String> assessmentMap) {
            return Maybe.of(assessmentMap.get(assessment));
          }
        };
